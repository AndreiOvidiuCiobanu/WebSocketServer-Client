...
namespace WebSocketServer.Middleware
{
    public class WebSocketServerMiddleware
    {
        ...
        private readonly WebSockerServerConnectionManager _manager;

        public WebSocketServerMiddleware(RequestDelegate next, WebSockerServerConnectionManager manager)
        {
            _next = next;
            _manager = manager;
        }
        ...
        private async Task ReceiveMessage(WebSocket socket, Action<WebSocketReceiveResult, byte[]> handleMessage)
        {
            ...
            {
                //reference parameters in a different order
